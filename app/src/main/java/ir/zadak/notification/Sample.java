                    ...
                    switch (mPosSelected) {
                        ...
                        case 2:
                            mLoad.inboxStyle(getResources().
                                            getStringArray(R.array.notification_inbox_lines),
                                    title,
                                    getResources().getString(R.string.text_summary))
                                    .simple()
                                    .build();
                            break;
                    }
